...
public class Doctor {
	...
	public Doctor(double doctorId, String doctorName, String department, Set<Patient> patients) {
		super();
	...
	public int hashCode() {
		...
		long temp;
		temp = Double.doubleToLongBits(doctorId);
	...
	public boolean equals(Object obj) {
		...
		if (department == null) {
			...
			return false;
		if (Double.doubleToLongBits(doctorId) != Double.doubleToLongBits(other.doctorId))
			return false;
		if (doctorName == null) {
	...
	public void put(int i, Doctor d1) {
		// TODO Auto-generated method stub
		
	}

	public Set<Entry<Doctor, Set<Patient>>> entrySet() {
		// TODO Auto-generated method stub
		return null;
	}

	public Collection<Doctor> getvalues() {
		// TODO Auto-generated method stub
		return null;
	} 

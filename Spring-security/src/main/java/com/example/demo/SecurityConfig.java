...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	String sql="SELECT u.username, a.authority FROM bhu_authorities a, bhu_users u  WHERE u.username = AND u.username = a.username"; 
...
//		
		...
		usersByUsernameQuery("select username,password,enabled from bhu_users where username=?")

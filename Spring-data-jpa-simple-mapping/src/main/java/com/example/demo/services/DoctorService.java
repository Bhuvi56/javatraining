...
public class DoctorService {
	...
	public Doctor findByDocName(String doctorName){
		
		return this.repo.findByDoctorName(doctorName);
	}
...
public List<Doctor> findByNameAndDepart(String name,String dept){
//		
